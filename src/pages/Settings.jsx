  ...
  return (
    <div className="space-y-4 pb-4">
      ...
      <ManualSection icon="🖼️" title="如何瀏覽與篩選作品">
        ...
        <Step num="2" text="頁面上方有篩選器，可按「教學狀態」、「季節」、「節日」、「材料」過濾作品，可以同時使用多種篩選條件。" />
        <Step num="3" text="選擇中心後，篩選器頂部出現「⭐ 未教過」／「✓ 已教過」按鈕，讓你快速找出適合的作品。" />
        <Step num="4" text="每張作品卡片右上角也會出現狀態標籤：「✓ 已教過」（綠色）或「⭐ 可教」（藍色）。" />
        <Step num="5" text="點擊作品卡片可進入詳細頁面，查看完整資訊與教學歷史。" />
        <Tip text="課前準備：切換到「要去的中心」→ 點「⭐ 未教過」→ 再選季節或材料，最適合的作品一目瞭然！" />
      </ManualSection>
      ...
      {/* 教學狀態篩選 */}
      <ManualSection icon="🎯" title="用教學狀態快速找作品">
        <p>選擇活動中心後，作品庫篩選器最上方會出現「教學狀態」列，讓你一鍵分類：</p>
        <Step num="1" text="先在右上角切換到你要去（或剛去完）的活動中心。" />
        <Step num="2" text="在篩選器最上方看到「⭐ 未教過」和「✓ 已教過」兩個按鈕。" />
        <Step num="3" text="點擊「⭐ 未教過」→ 只顯示這個中心還沒教過的作品，適合課前備課選材。" />
        <Step num="4" text="點擊「✓ 已教過」→ 只顯示已有教學記錄的作品，適合回顧或找重複教材。" />
        <Step num="5" text="再點一次同一個按鈕即可取消，「清除所有篩選」也會同時重設教學狀態篩選。" />
        <Tip text="課前最佳流程：切換中心 → 點「⭐ 未教過」→ 再搭配季節或材料篩選，最適合的作品馬上浮現！" />
        <Tip icon="ℹ️" text="沒有選擇中心時此篩選不會顯示，因為教學狀態需要以「特定中心」為基準才有意義。" />
      </ManualSection>
      ...
      <ManualSection icon="❓" title="常見問題 FAQ">
        <div className="space-y-4">
          {[
            ...
            { q: '教學狀態篩選沒有出現', a: '教學狀態篩選只有在已選擇活動中心時才會顯示。請先點右上角「選擇中心」選擇一個中心，再回到作品庫即可看到。' },
